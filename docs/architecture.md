...
| `payroll.rates.monthly-2026` | **generated** — the 月額表 as data, pinned by SHA-256 (`tools/import_nta_2026.cljk`) |
...
| 5 | a bank | a test transfer. The 全銀協 総合振込 record layout was read (section 8, business type 21) and `payroll.artifact.zengin/prepare` builds the file; what remains is outside this repository — no bank has accepted a file this code produced. |
